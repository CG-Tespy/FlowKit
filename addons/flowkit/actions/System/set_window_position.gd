...
static var _x_input := FKActionInput.new("X", "int", "The X position of the window in pixels.")
static var _y_input := FKActionInput.new("Y", "int", "The Y position of the window in pixels.")
