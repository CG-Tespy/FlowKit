...
static var _bus_name_input := FKActionInput.new("Bus Name", "String",
"The name of the audio bus (e.g., 'Master', 'Music', 'SFX').")
static var _muted_input := FKActionInput.new("Muted", "bool", "Whether the audio bus should be muted.")
