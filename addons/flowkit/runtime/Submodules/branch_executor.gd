...
func _evaluate_condition(act: FKActionBlock, current_root: Node, block_id: String) -> bool:
...
func _should_execute_branch(act: FKActionBlock, provider: Variant, 
...
func _get_branch_inputs(act: FKActionBlock, current_root: Node) -> Dictionary:
